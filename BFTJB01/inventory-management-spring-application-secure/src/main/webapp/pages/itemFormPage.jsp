...
<body>
	...
	<form:form action='${isNew?pageContext.request.contextPath.concat("/admin/addItem"):pageContext.request.contextPath.concat("/admin/saveItem") }' method="POST" modelAttribute="item">
		<div>
